...
CREATE TABLE `interface_result` (
  ...
  `status` TINY_INT(2) unsigned NOT NULL DEFAULT 0 COMMENT "0 打开, 1 确认, 2 解决, 3 误判, 4 标记为不会修复",
  `create_date` datetime(6) NOT NULL DEFAULT "1070-01-01 00:00:00" COMMENT "创建时间",
  `response_txt` longtext NOT NULL DEFAULT "" COMMENT "响应数据, 文本",
  `response_headers` longtext NOT NULL DEFAULT "" COMMENT "响应头",
  `response_cookie` longtext NOT NULL DEFAULT "" COMMENT "响应cookie",
  `status_code` SMALLINT (4) NOT NULL DEFAULT 0 COMMENT "响应码",
  `context_variable` longtext NOT NULL DEFAULT "" COMMENT "上下文变量数据",
  `validators` longtext NOT NULL DEFAULT "" COMMENT "上下文变量数据",
  PRIMARY KEY (`id`)
)ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `context_variable` (
  ...
  `method` TINYINY(2) NOT NULL DEFAULT 0 COMMENT "0 JSON 1 RE 2 ALL",
  `rules` VARCHAR (50) NOT NULL DEFAULT "" COMMIT "规则"
)ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4;
